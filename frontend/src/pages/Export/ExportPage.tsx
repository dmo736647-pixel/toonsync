  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
        <h4 className="font-medium text-blue-900 mb-3">💡 导出说明</h4>
        <ul className="text-sm text-blue-800 space-y-2">
          <li>• <strong>竖屏优化</strong>：9:16比例适合移动端观看</li>
          <li>• <strong>费用估算</strong>：根据视频时长和分辨率计算</li>
          <li>• <strong>渲染时间</strong>：1-3分钟视频约需5分钟</li>
          <li>• <strong>文件保存</strong>：导出的视频保存30天</li>
        </ul>
      </div>
    </div>
  );
